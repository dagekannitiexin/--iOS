...
class ViewController: UIViewController {
    ...
    @IBAction func tweetTapped(_ sender: AnyObject) {
        if (nameTextField.text == "" || workTextField.text == "" || salaryLabel.text == ""){
            showAlert("Info Miss", message: "plaese fill out the form", buttonTitle: "Ok")
            return
        }
        ...
        let tweet = "Hi, I am \(name).As a \(age)-yeae-old \(work) earning \(salary) year, I am interested in \(interestedIn). Feel free to contact me!,"
